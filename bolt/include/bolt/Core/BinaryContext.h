...
struct ProgramHeader {
  ...
  void print(raw_ostream &OS) const {
    OS << "ProgramHeader { type: 0x" << Twine::utohexstr(p_type)
       << ", flags: 0x" << Twine::utohexstr(p_flags)
       << ", offset: 0x" << Twine::utohexstr(p_offset)
       << ", vaddr: 0x" << Twine::utohexstr(p_vaddr)
       << ", filesz: 0x" << Twine::utohexstr(p_filesz)
       << ", memsz: 0x" << Twine::utohexstr(p_memsz)
       << ", align: 0x" << Twine::utohexstr(p_align) << " }";
  }
};

...
# CHECK-BOLT:      nop # Size: 1 # NOP: 1
# CHECK-BOLT-NEXT: xchgw	%rax, %ax # Size: 2
# CHECK-BOLT-NEXT: nopl	(%rax) # Size: 3 # NOP: 1
# CHECK-BOLT-NEXT: {disp8}	nopl	(%rax) # Size: 4 # NOP: 1
# CHECK-BOLT-NEXT: {disp8}	nopl	(%rax,%rax) # Size: 5 # NOP: 1
# CHECK-BOLT-NEXT: {disp8}	nopw	(%rax,%rax) # Size: 6 # NOP: 1
# CHECK-BOLT-NEXT: {disp32}	nopl	(%rax) # Size: 7 # NOP: 1
# CHECK-BOLT-NEXT: {disp32}	nopl	(%rax,%rax) # Size: 8 # NOP: 1
# CHECK-BOLT-NEXT: {disp32}	nopw	(%rax,%rax) # Size: 9 # NOP: 1
# CHECK-BOLT-NEXT: {disp32}	nopw	%cs:(%rax,%rax) # Size: 10 # NOP: 1
## Sizes 11-15: split into 10 + remainder
# CHECK-BOLT-NEXT: {disp32}	nopw	%cs:(%rax,%rax) # Size: 10 # NOP: 1
# CHECK-BOLT-NEXT: nop # Size: 1 # NOP: 1
# CHECK-BOLT-NEXT: {disp32}	nopw	%cs:(%rax,%rax) # Size: 10 # NOP: 1
# CHECK-BOLT-NEXT: xchgw	%rax, %ax # Size: 2
# CHECK-BOLT-NEXT: {disp32}	nopw	%cs:(%rax,%rax) # Size: 10 # NOP: 1
# CHECK-BOLT-NEXT: nopl	(%rax) # Size: 3 # NOP: 1
